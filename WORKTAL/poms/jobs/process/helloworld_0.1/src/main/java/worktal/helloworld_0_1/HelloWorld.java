...
package worktal.helloworld_0_1;
...
/**
 * Job: HelloWorld Purpose: <br>
 * Description:  <br>
 * @author elvisrocha@xipp.com.br
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class HelloWorld implements TalendJob {
	...
	private final String jobName = "HelloWorld";
	private final String projectName = "WORKTAL";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HelloWorld.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final HelloWorld HelloWorldClass = new HelloWorld();

		int exitCode = HelloWorldClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HelloWorld.class.getClassLoader()
					.getResourceAsStream(
							"worktal/helloworld_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = HelloWorld.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : HelloWorld");
		}
...
/************************************************************************************************
 * 23299 characters generated by Talend Open Studio for Data Integration on the
 * 2 de Setembro de 2019 17h24min33s BRT
 ************************************************************************************************/
